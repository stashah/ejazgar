                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Mutual Fund</h4>
                                    <p class="card-description">
                                        Mutual Fund <code>.Details</code>
                                        ...
                                        <table id="example1" class="table table-light table-bordered display table-sm" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php $total=0; while ($row = $result->fetch_assoc()) { $total = $total + $row["amount"]; ?>
                                                    <tr>
                                                        <td><a href="reportformember.php?id=<?= $row["custid"]; ?>"><?= htmlspecialchars($row["id"]); ?></a></td>
                                                        
                                                        <td><a href="reportformember.php?id=<?= $row["custid"]; ?>"><?= htmlspecialchars($row["custname"]); ?></a></td>
