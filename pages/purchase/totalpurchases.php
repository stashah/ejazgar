...
$tday = date("Y-m-d", strtotime("-1 months"));
$sql = "SELECT * FROM `purchase` join products on purchase.productid=products.pid "; //where purdate>='".$tday."'
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Total Purchases <code>.Date Wise</code>
                                            ...
                                            <tbody>
                                                <?php while ($row = $result->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= htmlspecialchars($row["productid"]); ?></a></td>
