...
$pid =1;
$result ="";
if(isset($_POST['idpid'])) {
    
$pid = $_POST['idpid'];
$sql = "SELECT * FROM `sale` join products on sale.productid=products.pid WHERE productid='".$pid."'";
$result = $conn->query($sql);
}
else{
    
          $msg= '<div class="p-3 mb-2 bg-warning text-white">Fill all fields...</div>';
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" id="idpid" name="idpid" placeholder="Product Id" min="0" autofocus class="form-control form-control-sm">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                                <input class="btn btn-block btn-primary btn-sm font-weight-medium " type="submit" id="btnSearch" name="btnSearch" value="Search..."/>
                                    </div> 
                                            ...
                                            <tbody>
                                                <?php if($result!=""){ while ($row = $result->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= htmlspecialchars($row["pname"]); ?></a></td>
