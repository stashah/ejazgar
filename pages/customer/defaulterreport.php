...
$sql = "SELECT ntcinfo.custid, ntcinfo.dt, ntcinfo.amount,c.custname,c.custmobile,c.custaddress from (SELECT nt.custid, nt.dt, sum(nt.cf+nt.amount-nt.pamount) as amount  FROM (SELECT custid, saldate as dt, sum(salqty*salprice) as amount,'' as pamount, '' as cf FROM sale where account=1 GROUP BY custid 
UNION
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive tt">
                                        ...
                                        <div>
                                            Show / Hide Column: <a class="toggle-vis-ex1" <a class="toggle-vis-ex1" data-column="2">Mobile</a> - <a class="toggle-vis-ex1" data-column="3">Address </a>
                                        </div>
